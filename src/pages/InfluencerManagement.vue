    ...
    <section id="cta" class="scroll-reveal relative mt-16 md:mt-24 lg:mt-48">
      <div class="relative z-10 max-w-screen-lg mx-auto px-4 sm:px-8 py-12 md:py-24 grid grid-cols-1 md:grid-cols-2">
        <div>
          ...
          <div class="pt-4 text-black-500 html-content" v-html="$page.influencerManagement.cta.text"></div>
        ...
        <div class="px-4 sm:px-0 mt-16 md:mt-12 ml-0 md:ml-16">
          ...
          <a v-bind:href="$page.influencerManagement.cta.stats_source" target="_blank" class="text-xs font-bold tracking-widest uppercase text-dark-100 hover:text-dark-300">Quelle <i class="fas fa-external-link-alt"></i></a>
        </div>
      </div>
